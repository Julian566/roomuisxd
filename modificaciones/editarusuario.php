...
$sql2="select * from usuario where iduser='$id' LIMIT 1";
    $result = pg_query($conn,$sql1);
$result3 = pg_query($conn,$sql2);
	$row2=pg_fetch_array($result3);
?>
<section>
<br/> <br/>
<form method="post" action="../admin/modificarusuario.php" onsubmit="return validarUsuario()">
<center>
<table width="1600" height="224" border="3" bgcolor="#9BCDED">
<tr>
<th height="61" colspan="4" align="center">
<font color="#663333" size="6">Editar usuario</font>
</th>
</tr>
  <tr>
    <td width="254" height="120" align="center"><input type="hidden" name="id" id="codigo" value="<?php echo $row2['0']; ?>"/>
<p><br/><label> <strong>Nombres:</strong>
  <input type="text" name="nombre" id="nombre" placeholder="Digite el nombre" onkeyup="return mayuscula(this)" onkeypress="return letra(event)" value="<?php echo $row2['1']; ?>"></label></p>
  <p><br/> <label><strong>Apellidos:</strong></label>
    <input type="text" name="apellidos2" id="apellido" placeholder="Digite los apellidos" onkeyup="return mayuscula(this)" onkeypress="return letra(event)" value="<?php echo $row2['2']; ?>">
  </p><br/>
  </td>
    <td width="305" align="center"><p><br/> <label><strong>Nickname:</strong>
  <input type="text" name="nickname" id="nickname" placeholder="Digite el nickname" value="<?php echo $row2['4']; ?>"></label></p>
<p><br/> <label><strong>Contrase&ntilde;a:</strong>
  <input type="password" name="contra" id="contrasena" placeholder="Digite la contrase&ntilde;a" value="<?php echo $row2['6']; ?>"></label></p>
  <p><br/> <label><strong>Correo:</strong>
  <input type="text" name="correo" id="correo" placeholder="Digite el correo" value="<?php echo $row2['5']; ?>"></label></p><br/>
...
<p> <br/><label><strong>Fecha nacimiento:</strong>
  ...
  <input type="tel" name="tel" id="telefono" placeholder="Digite el tel&eacute;fono" onkeypress="return numero(event)" value="<?php echo $row2['12']; ?>"></label></p><br/></td>
...
<p> <br/><label><strong>Dinero:</strong>
  <input type="number" name="dinero" id="dinero" placeholder="Ingrese el dinero" onkeypress="return numero(event)" value="<?php echo $row2['3']; ?>"></label></p>
<p><br/> <label><strong>Puntos:</strong>
  <input type="number" name="puntos" id="puntos" placeholder="Ingrese los puntos" onkeypress="return numero(event)" value="<?php echo $row2['9']; ?>"></label></p>
...
?>
  ...
  Enviar
</button> <button type="button"><img src="../admin/borrar.svg" alt="Borrar todo" width="32" height="32" style="vertical-align: middle"><a href="../consultas/verusuario.php">Volver</a></img></button>
	  </td>
  </tr>
</table></center>
</form>
